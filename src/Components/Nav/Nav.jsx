...
function Nav() {
  ...
  useEffect(() => {
    if (!isPathNameRoot) {
      handelNavbarBgColor.current.classList.add("bg-black");
      handelNavbarBgColor.current.classList.remove("absolute");
    } else {
      handelNavbarBgColor.current.classList.remove("bg-black");
      ...
      >
        <header className="py-2  dark:bg-gray-100 dark:text-gray-800">
          <div className="container flex justify-between items-center container mx-auto text-white h-16 mx-auto">
            <div className="">
             <img className="h-[90px]" src="https://i.ibb.co/w05srsd/Logo-removebg-preview.png" alt="" />
            </div>
            <div>
                ...
                <div className="flex  gap-x-4">
                  <NavLink
                    ...
                    className={({ isActive }) => {
                      ...
                      dark:text-gray-50
                      animate__animated
                      ${isActive ? "text-[#0091FF] !font-extrabold" : ""}
                    `;
                    }}
                  >
                    Log in
